...
public class GetHistoricoPlayerByIdHandler(IRepository<HistoricoPlayer> repository, IMapper mapper) : IRequestHandler<GetHistoricoPlayerById, HistoricoPlayerDTO>
{

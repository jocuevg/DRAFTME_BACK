        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Formacion = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    NumSocios = table.Column<int>(type: "int", nullable: false),
                    ...
                    Escudo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Categorias_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricosTeam", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoricosTeam_Categorias_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistoricosTeam_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Asistencias = table.Column<int>(type: "int", nullable: false),
                    Minutos = table.Column<int>(type: "int", nullable: false),
                    HistoricoTeamId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricosPlayer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoricosPlayer_HistoricosTeam_HistoricoTeamId",
                        column: x => x.HistoricoTeamId,
                        principalTable: "HistoricosTeam",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistoricosPlayer_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoricosPlayer_HistoricoTeamId",
                table: "HistoricosPlayer",
                column: "HistoricoTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricosPlayer_PlayerId",
                table: "HistoricosPlayer",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricosTeam_CategoriaId",
                table: "HistoricosTeam",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricosTeam_TeamId",
                table: "HistoricosTeam",
                column: "TeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scouters_UserId",
                table: "Scouters",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Teams_CategoriaId",
                table: "Teams",
                column: "CategoriaId");
        }

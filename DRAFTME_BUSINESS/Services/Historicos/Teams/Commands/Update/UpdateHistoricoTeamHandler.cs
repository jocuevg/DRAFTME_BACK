...
public class UpdateHistoricoTeamHandler(IRepository<HistoricoTeam> repository, IValidator<UpdateHistoricoTeam> validator, Mapper mapper) : IRequestHandler<UpdateHistoricoTeam, HistoricoTeamDTO>
{

...
public class CreateHistoricoPlayerValidation : AbstractValidator<CreateHistoricoPlayer>
{
    public CreateHistoricoPlayerValidation(IRepository<Player> repository, IRepository<HistoricoTeam> repositoryHistorico)
    {

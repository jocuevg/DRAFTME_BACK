...
public class CreateHistoricoTeamValidation : AbstractValidator<CreateHistoricoTeam>
{
    public CreateHistoricoTeamValidation(IRepository<Categoria> repository, IRepository<Team> repositoryTeam)
    {
